...
public class Test
{
    static String clientId="2368268313";//你的应用ID
    static String clientSecret="6d85a212e3bc69c22bb3f309e9d4ada9";//你的应用密码
    static String redirectUri="http://localhost:8080/jsp/index.jsp";//你在应用管理中心设置的回调页面
